...
4. **The precipitation scenarios DO ship.** `stage1-python/precips_c0_{DML,EP}.csv` are
   100,000 Monte Carlo draws each, generated by `markov_chain.Rmd`, but they are *inputs* to the
